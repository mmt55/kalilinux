...
Client, Web and Password Attacks
  ...
  `a'; return this.a != 'BadData’'; var dummy='!`
    ...
    Password Hash Attacks
        ...
        Hashcat Needed to install new drivers to get my GPU Cracking to work on the Kali linux VM and I also had to use the --force parameter. apt-get install libhwloc-dev ocl-icd-dev ocl-icd-opencl-dev and apt-get install pocl-opencl-icd
